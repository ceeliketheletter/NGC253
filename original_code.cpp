...
int main(int argc, char **argv){
    //TGraph protdist;
    //ofstream fne("/Users/toniaventers/Work/AstrophysicalModeling/NGC253/Results/Tests/Lacki/400muG/ne_prot_ss_finite_exp_cutoff.dat");
    ...
    switch (specflag) {
        ...
        ofstream myfile;
        myfile.open ("original_code4.txt");
    
        cout << "# " << "Output file of: 'original_code.cpp' " << endl;
        
        cout << "Given : " << "[" << argv[1] << "  " << argv[2] << "  " << argv[3] << "  " << argv[4] << "  " << argv[5] << "  " << argv[6] << "  " << argv[7] << "]" <<endl;
        cout << '#' << '\n';
        cout << "# " << "loggamma" << "\t" << "log10(ne_ss)" << endl;
    ...
    /*for (loggamma=.1; loggamma<=11; loggamma+=logbinsize)
            { */
                ...
                cout << loggamma << "\t" << "\t" << log10(ne_ss) << endl; //to save to a file, use myfile instead of cout   
